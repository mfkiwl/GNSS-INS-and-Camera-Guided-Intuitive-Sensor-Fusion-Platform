...
class CloudPainter
{
  ...
  private:
     ...
     */
    void actionServerCallback(const mst_object_localization::ProjectedCloudGoalConstPtr& goal);
    ...
    //! ActionServer.
    actionlib::SimpleActionServer<mst_object_localization::ProjectedCloudAction> m_action_server;

    //! ActionServer result message.
    mst_object_localization::ProjectedCloudResult m_result;
