...
_C.DATASET.DATAROOT = '/home/bzeren/lane_ws/src/YOLOP/dataset/images/'       # the path of images folder
_C.DATASET.LABELROOT = '/home/bzeren/lane_ws/src/YOLOP/dataset/det_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/home/bzeren/lane_ws/src/YOLOP/dataset/da_seg_annotations'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/home/bzeren/lane_ws/src/YOLOP/dataset/ll_seg_annotations'               # the path of ll_seg_annotations folder
...
_C.TRAIN.VAL_FREQ = 1
_C.TRAIN.BATCH_SIZE_PER_GPU = 2 # 24
