...
#include "mst_object_localization/PointCloudOpen3D.hpp"
#include "mst_object_localization/lidar_tracker/Object.hpp"
...
class SignFinder
{
  ...
  private:
    ...
    utils::PointCloudOpen3D clusterSign (utils::PointCloudOpen3D& t_o3d_point_cloud);
